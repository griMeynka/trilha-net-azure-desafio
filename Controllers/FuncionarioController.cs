...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        funcionarioBanco.Departamento = funcionario.Departamento;  // Atualiza a propriedade do Departamento
        funcionarioBanco.Salario = funcionario.Salario;  // Atualiza a propriedade de Salário

        _context.Funcionarios.Update(funcionarioBanco); // Chama o método de Update para salvar no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        _context.Funcionarios.Remove(funcionarioBanco);  // Chama o método de Remove para salvar no Banco SQL
        _context.SaveChanges();
